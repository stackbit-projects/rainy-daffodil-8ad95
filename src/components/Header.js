                ...
                <div className="container">
                    <nav className="navbar flex items-center" aria-label="Main Navigation">
                        ...
                        <div className="navbar__branding mr-2">
                            {logo ? <Link className="navbar__logo m-0" href={withPrefix('Malvika')}><img src={withPrefix(logo)} alt={logoAlt} /></Link>
                                : <Link className="navbar__title h4 m-0" href={withPrefix('Malvika')}>{title}</Link>}
                        </div>
